 ...
 *   id = "file_reference_field",
 *   label = @Translation("File Refererence (includes url)"),
 *   description = @Translation("Includes file url")
 * )
 */
class FileFieldEnhancer extends ResourceFieldEnhancerBase implements ContainerFactoryPluginInterface {
