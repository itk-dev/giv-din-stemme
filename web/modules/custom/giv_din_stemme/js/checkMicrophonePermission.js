...
function getLocalStream() {
  ...
  const microphoneAllowedDisplay = document.getElementById(
    "microphone-allowed-display",
  );
  const microphoneDisallowedDisplay = document.getElementById(
    "microphone-disallowed-display",
  );
